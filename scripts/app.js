define(['d3', 'underscore', 'jquery'], function (d3, _, $) {
    "use strict";
...
//            });
        ...
        var precipInnerRadius = daysInnerRadius + (padding );
        ...
        clipPath.selectAll("rect.temp").data(stats)
            ...
            .attr('width', function (d) {
                return tempScale((d.TMAX - d.TMIN));
            })
            .attr('height', 4)
            .attr("transform", function (d, i) {
        ...
        // Legend
        var legend = d3.select('#legendViz').append('svg').attr('height', 400).append('g');
        var sampleDay = 200;
        ...
        legendClipPath.selectAll("rect.temp").data([stats[sampleDay]])
            ...
            .attr('height', function (d) {
                return detailTempScale((d.TMAX - d.TMIN));
            })
            .attr("transform", function (d, i) {
